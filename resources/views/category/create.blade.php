        ...
        <div class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-md rounded p-6  overflow-visible">
            <div class="flex items-center justify-between mb-4">
                ...
                <form action="{{ route('category.store') }}" method="post" class=" rounded px-8 pt-6 pb-8 mb-4">
                        @csrf
                        <div class="mb-4">
                            <label for="nameCategory" class="block text-white text-sm font-bold mb-2">Nombre de la categoría</label>
                            <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nameCategory" name="nameCategory" required>
                        </div>
