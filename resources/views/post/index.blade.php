                ...
                <div class="bg-gray-700 px-4 py-2 rounded-b-lg">
                    <div class="flex justify-between">
                        <a href="{{ route('post.edit', $post) }}"
                            class="bg-blue-500 hover:bg-blue-600 text-white text-sm font-semibold py-1 px-3 rounded">Editar</a>
                        ...
                        <div>
                            <form action="{{ route('post.destroy', $post) }}" method="post">
                                ...
                                @method('DELETE')
                                <button type="submit"
                                    class="bg-red-500 hover:bg-red-600 text-white text-sm font-semibold py-1 px-3 rounded">Borrar
                                </button>
                            </form>
                        </div>
                    </div>
